...
| `StorageDRState`                                               | [shared.StorageDRState](../../models/shared/storagedrstate.md) | :heavy_check_mark:                                             | Status of Storage DR operation                                 |
| `StorageDRType`                                                | [shared.StorageDRType](../../models/shared/storagedrtype.md)   | :heavy_check_mark:                                             | Name of Storage DR operation                                   |
